...
helm upgrade --install prometheus-msteams --namespace <MONITORING-NAMESPACE> -f values.yaml prometheus-msteams/prometheus-msteams

REFERENCE: 
https://github.com/prometheus-msteams/prometheus-msteams/tree/master/chart/prometheus-msteams
